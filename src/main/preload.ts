...
contextBridge.exposeInMainWorld('electronAPI', {
	...
	// Save image buffer as output/<system>/<thumbnailDir>/<game>.png
	saveImageForGame: (system: string, game: string, buffer: ArrayBuffer, root?: string, thumbnailDir?: string) => ipcRenderer.invoke('save-image-for-game', { system, game, buffer, root, thumbnailDir }),
	...
	deleteThumbnail: (system: string, game: string, root?: string, thumbnailDir?: string) => ipcRenderer.invoke('delete-thumbnail', { system, game, root, thumbnailDir }),
	deleteRom: (system: string, game: string, root?: string, thumbnailDir?: string) => ipcRenderer.invoke('delete-rom', { system, game, root, thumbnailDir }),
	createSystemDir: (system: string, root?: string) => ipcRenderer.invoke('create-system-dir', { system, root }),
	getThumbnail: (system: string, game: string, root?: string, thumbnailDir?: string) => ipcRenderer.invoke('get-thumbnail', { system, game, root, thumbnailDir }),
